...
public class OkHttpUtils {
    ...
    /**
     * Description : OkHttp网络连接封装工具类 Author : lauren Email :
     * lauren.liuling@gmail.com Blog : http://www.liuling123.com Date : 15/12/17
     */
                ...
                public void onResponse(Response response) throws IOException {
                    try {
                        ...
                        if (callback.mType == String.class) {
                            ...
                            Object object = JsonUtils.deserialize(str,
                                    callback.mType);
